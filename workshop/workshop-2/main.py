...
if __name__ == '__main__':
    ...
    if args.mode == "PRODUCER":
        ...
        if args.task == "predict":
            consume_reviews(predict, topic, args.consumer_group + "-predict")
        elif args.task == "train":
            consume_reviews(train, topic, args.consumer_group + "-train")
        else:
            logging.error("Unrecognized consumer task={task}".format(task = args.task))
